...
def distanceBetweenZoffset(cloud1, cloud2, target_dist=None):
    """
    Both positional arguments are n*3 np.arrays
    ...
    min_stepsize = 0.001  # use to move cloud2 closer
    dis_tol = 0.001
    negated = False
    cloud1name = "cloud1"
    cloud2name = "cloud2"
    ...
    if target_dist is not None:
        ...
        while mindist - target_dist > dis_tol:
...
try:
    ...
    sys.exit(f"Unable to parse {args.filename2}.")
